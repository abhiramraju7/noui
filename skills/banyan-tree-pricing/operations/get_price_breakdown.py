#!/usr/bin/env python3
"""Get Banyan Tree Hotels's public base price, discount, tax, and final price through Tabby."""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Get an Banyan Tree Hotels property's public price breakdown."
    )
