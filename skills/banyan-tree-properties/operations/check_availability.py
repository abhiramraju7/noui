#!/usr/bin/env python3
"""Check whether an Banyan Tree Hotels property is publicly available for selected dates."""
...
from noui_runtime.banyan_tree import find_hotel, get_hotel_rates, search_hotels
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Check Banyan Tree Hotels property availability.")
