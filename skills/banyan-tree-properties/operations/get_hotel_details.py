#!/usr/bin/env python3
"""Get one Banyan Tree Hotels hotel's normalized public details through Tabby."""
...
from noui_runtime.banyan_tree import find_hotel, search_hotels
...
async def execute(
    ...
    return find_hotel(result, hotel_id)


def main() -> int:
    parser = argparse.ArgumentParser(
        description="Get Banyan Tree Hotels hotel details from a destination search."
    )
    ...
    try:
        ...
        print(f"get_hotel_details failed: {exc}", file=sys.stderr)
        return 1
