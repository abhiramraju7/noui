#!/usr/bin/env python3
"""List public amenities for an Banyan Tree Hotels property through Tabby."""
...
from noui_runtime.banyan_tree import find_hotel, get_hotel_amenities, search_hotels
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="List amenities for an Banyan Tree Hotels property."
    )
