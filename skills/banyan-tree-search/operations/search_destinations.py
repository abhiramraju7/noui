#!/usr/bin/env python3
"""Search Banyan Tree Hotels destinations through Tabby-routed execute/fetch."""
...
from noui_runtime.banyan_tree import search_destinations
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Search Banyan Tree Hotels cities and neighbourhoods."
    )
