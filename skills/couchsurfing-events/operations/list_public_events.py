#!/usr/bin/env python3
"""List public Couchsurfing event links through Tabby."""
...
from noui_runtime.couchsurfing import list_public_events
...
async def execute(query: str = "", limit: int = 20, profile_slug: str | None = None) -> list[dict]:
    ...
    return await list_public_events(query, limit=limit, profile_slug=profile)
...
def main() -> int:
    ...
    try:
        ...
        print(f"list_public_events failed: {exc}", file=sys.stderr)
        return 1
