...
description: Use when the user wants to search Expedia travel packages, inspect public flight-and-stay package results, or review publicly displayed package prices for a destination and dates.
---

# Expedia Packages

Search Expedia public package pages through Tabby `POST /execute/fetch`. Browser cookies and networking remain inside the Tabby session; never connect to a client-side CDP socket or extract credentials by default.
