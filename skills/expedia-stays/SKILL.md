---
name: expedia-stays
description: Use when the user wants to search Expedia hotels, inspect public accommodation results, or review publicly displayed hotel prices for a destination and stay dates.
---

# Expedia Stays

Search Expedia public hotel pages through Tabby `POST /execute/fetch`. Browser cookies and networking remain inside the Tabby session; never connect to a client-side CDP socket or extract credentials by default.
