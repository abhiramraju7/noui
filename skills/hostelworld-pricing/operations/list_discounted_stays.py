#!/usr/bin/env python3
"""List Hostelworld stays meeting a minimum advertised discount through Tabby."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="List discounted Hostelworld stays.")
