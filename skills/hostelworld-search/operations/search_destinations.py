#!/usr/bin/env python3
"""Search Hostelworld destinations through Tabby-routed execute/fetch."""
...
from noui_runtime.hostelworld import search_destinations
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Search Hostelworld cities and neighbourhoods.")
