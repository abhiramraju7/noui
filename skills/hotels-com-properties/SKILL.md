...
description: Use when the user wants to inspect Hotels.com properties, inspect public accommodation results, or review publicly displayed hotel prices for a destination and stay dates.
---

# Hotels.com Properties

Inspect Hotels.com public property pages through Tabby `POST /execute/fetch`. Browser cookies and networking remain inside the Tabby session; never connect to a client-side CDP socket or extract credentials by default.
