---
name: hotels-com-vacation-rentals
description: Use when the user wants to search Hotels.com homes and vacation rentals, inspect public home and rental results, or review publicly displayed home prices for a destination and stay dates.
---

# Hotels.com Vacation Rentals

Search Hotels.com public home and vacation-rental pages through Tabby `POST /execute/fetch`. Browser cookies and networking remain inside the Tabby session; never connect to a client-side CDP socket or extract credentials by default.
