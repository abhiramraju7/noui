#!/usr/bin/env python3
"""Get one Jumeirah hotel's normalized public details through Tabby."""
...
from noui_runtime.jumeirah import find_hotel, search_hotels
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Get Jumeirah hotel details from a destination search."
    )
