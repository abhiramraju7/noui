#!/usr/bin/env python3
"""Compare available Jumeirah hotels by final public price through Tabby."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Compare Jumeirah hotels by final public price.")
