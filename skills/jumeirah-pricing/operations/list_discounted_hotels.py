#!/usr/bin/env python3
"""List Jumeirah hotels meeting a minimum advertised discount through Tabby."""
...
from noui_runtime.jumeirah import get_hotel_rates, search_hotels
...
def main() -> int:
    parser = argparse.ArgumentParser(description="List discounted Jumeirah hotels.")
