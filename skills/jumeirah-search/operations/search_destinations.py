#!/usr/bin/env python3
"""Search Jumeirah destinations through Tabby-routed execute/fetch."""
...
from noui_runtime.jumeirah import search_destinations
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Search Jumeirah cities and neighbourhoods.")
