#!/usr/bin/env python3
"""Search Jumeirah hotels and return normalized public prices through Tabby."""
...
from noui_runtime.jumeirah import search_hotels
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Search Jumeirah hotels by destination and dates.")
