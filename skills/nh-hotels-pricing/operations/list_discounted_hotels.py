#!/usr/bin/env python3
"""List NH Hotels properties meeting a minimum advertised discount through Tabby."""
...
from noui_runtime.nh_hotels import get_hotel_rates, search_hotels
...
async def execute(
    ...
    profile = profile_slug or os.environ.get("PROFILE_SLUG") or "nh-hotels"
...
def main() -> int:
    parser = argparse.ArgumentParser(description="List discounted NH Hotels properties.")
