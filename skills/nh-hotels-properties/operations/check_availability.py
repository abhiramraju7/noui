#!/usr/bin/env python3
"""Check whether an NH Hotels property is publicly available for selected dates."""
...
from noui_runtime.nh_hotels import find_hotel, get_hotel_rates, search_hotels
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Check NH Hotels property availability.")
