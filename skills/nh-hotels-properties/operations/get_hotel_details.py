#!/usr/bin/env python3
"""Get one NH Hotels hotel's normalized public details through Tabby."""
...
from noui_runtime.nh_hotels import find_hotel, search_hotels
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Get NH Hotels hotel details from a destination search."
    )
