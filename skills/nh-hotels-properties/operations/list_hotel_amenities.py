#!/usr/bin/env python3
"""List public amenities for an NH Hotels property through Tabby."""
...
from noui_runtime.nh_hotels import find_hotel, get_hotel_amenities, search_hotels
...
async def execute(
    ...
    amenities = await get_hotel_amenities(hotel, profile_slug=profile)
    return {"hotel_id": hotel["hotel_id"], "name": hotel["name"], "amenities": amenities}


def main() -> int:
    parser = argparse.ArgumentParser(description="List amenities for an NH Hotels property.")
