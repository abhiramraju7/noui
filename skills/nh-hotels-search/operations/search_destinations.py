#!/usr/bin/env python3
"""Search NH Hotels destinations through Tabby-routed execute/fetch."""
...
from noui_runtime.nh_hotels import search_destinations
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Search NH Hotels cities and neighbourhoods.")
