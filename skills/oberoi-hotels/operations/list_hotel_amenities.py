#!/usr/bin/env python3
"""List public amenities for an Oberoi hotel through Tabby."""
...
from noui_runtime.oberoi import find_hotel, get_hotel_amenities, search_hotels
...
def main() -> int:
    parser = argparse.ArgumentParser(description="List amenities for an Oberoi hotel.")
