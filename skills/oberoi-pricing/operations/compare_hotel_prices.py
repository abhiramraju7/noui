#!/usr/bin/env python3
"""Compare available Oberoi hotels by final public price through Tabby."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Compare Oberoi hotels by final public price.")
