#!/usr/bin/env python3
"""Get Oberoi's public base price, discount, tax, and final price through Tabby."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Get an Oberoi hotel's public price breakdown.")
