#!/usr/bin/env python3
"""List Oberoi hotels meeting a minimum advertised discount through Tabby."""
...
from noui_runtime.oberoi import get_hotel_rates, search_hotels
...
def main() -> int:
    parser = argparse.ArgumentParser(description="List discounted Oberoi hotels.")
