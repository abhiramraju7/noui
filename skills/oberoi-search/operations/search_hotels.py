#!/usr/bin/env python3
"""Search Oberoi hotels and return normalized public prices through Tabby."""
...
from noui_runtime.oberoi import search_hotels
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Search Oberoi hotels by destination and dates.")
