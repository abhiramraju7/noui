---
name: orbitz-cruises
description: Use when the user wants to search Orbitz cruises, inspect public cruise results, or review publicly displayed cruise prices for destination and dates.
---

# Orbitz Cruises

Search Orbitz public cruise pages through Tabby `POST /execute/fetch`. Browser cookies and networking remain inside the Tabby session; never connect to a client-side CDP socket or extract credentials by default.
