#!/usr/bin/env python3
"""Get OYO's public base price, discount, tax, and final price through Tabby."""
...
async def execute(
    ...
    return {
        ...
        "slashed_price": hotel["slashed_price"],
        "discount_percentage": hotel["discount_percentage"],
        "tax_amount": hotel["tax_amount"],
        "total_with_tax": hotel["total_with_tax"],
        "check_in": check_in,
        "check_out": check_out,
    }
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Get an OYO hotel's public price breakdown.")
