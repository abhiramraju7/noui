#!/usr/bin/env python3
"""Search OYO destinations through Tabby-routed execute/fetch."""
...
from noui_runtime.oyo import search_destinations
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Search OYO cities and neighbourhoods.")
