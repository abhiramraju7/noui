#!/usr/bin/env python3
"""Search OYO hotels and return normalized public prices through Tabby."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Search OYO hotels by destination and dates.")
