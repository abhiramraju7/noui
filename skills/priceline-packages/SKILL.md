---
name: priceline-packages
description: Use when the user wants to search Priceline travel packages, inspect public flight-and-stay package results, or review publicly displayed package prices for a destination and dates.
---

# Priceline Packages

Search Priceline public package pages through Tabby `POST /execute/fetch`. Browser cookies and networking remain inside the Tabby session; never connect to a client-side CDP socket or extract credentials by default.
