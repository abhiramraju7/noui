#!/usr/bin/env python3
"""Search Selina destinations through Tabby-routed execute/fetch."""
...
from noui_runtime.selina import search_destinations
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Search Selina cities and neighbourhoods.")
