#!/usr/bin/env python3
"""Search Sonder destinations through Tabby-routed execute/fetch."""
...
from noui_runtime.sonder import search_destinations
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Search Sonder cities and neighbourhoods.")
