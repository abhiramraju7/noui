#!/usr/bin/env python3
"""Get one Taj hotel's normalized public details through Tabby."""
...
from noui_runtime.taj import find_hotel, search_hotels
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Get Taj hotel details from a destination search.")
