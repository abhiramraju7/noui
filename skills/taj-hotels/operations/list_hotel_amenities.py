#!/usr/bin/env python3
"""List public amenities for a Taj hotel through Tabby."""
...
from noui_runtime.taj import find_hotel, get_hotel_amenities, search_hotels
...
def main() -> int:
    parser = argparse.ArgumentParser(description="List amenities for a Taj hotel.")
