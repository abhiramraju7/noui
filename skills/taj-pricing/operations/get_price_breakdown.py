#!/usr/bin/env python3
"""Get Taj's public base price, discount, tax, and final price through Tabby."""
...
from noui_runtime.taj import find_hotel, get_hotel_rates, search_hotels
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Get a Taj hotel's public price breakdown.")
