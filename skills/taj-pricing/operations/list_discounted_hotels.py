#!/usr/bin/env python3
"""List Taj hotels meeting a minimum advertised discount through Tabby."""
...
from noui_runtime.taj import get_hotel_rates, search_hotels
...
async def execute(
    ...
    profile = profile_slug or os.environ.get("PROFILE_SLUG") or "taj-hotels"
...
def main() -> int:
    parser = argparse.ArgumentParser(description="List discounted Taj hotels.")
