#!/usr/bin/env python3
"""Search Taj destinations through Tabby-routed execute/fetch."""
...
from noui_runtime.taj import search_destinations
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Search Taj cities and neighbourhoods.")
