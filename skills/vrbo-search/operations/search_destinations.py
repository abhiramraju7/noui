#!/usr/bin/env python3
"""Search Vrbo destinations through Tabby-routed execute/fetch."""
...
from noui_runtime.vrbo import search_destinations
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Search Vrbo cities and neighbourhoods.")
