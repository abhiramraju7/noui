#!/usr/bin/env python3
"""Search Vrbo stays and return normalized public prices through Tabby."""
...
from noui_runtime.vrbo import search_stays
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Search Vrbo stays by destination and dates.")
